...
namespace Docodemo.Async.Tasks.Extentions
{
    ...
    public static class AsyncTaskDoorExtensions
    {
        ...
        {
            return new ContextBuilder<TResult>(tasks, checkEmptyTasks, AsCancellableFuncTask(onAllTasksProcessedAsync));
        }
        ...
        {
            return new ContextBuilder(tasks, checkEmptyTasks, AsCancellableActionTask(onAllTasksProcessedAsync));
        }
        ...
        {
            return new ContextBuilder<TResult>(task, AsCancellableFuncTask(onAllTasksProcessedAsync));
        }
        ...
        {
            return new ContextBuilder<TResult>(task, Taskify(onAllTasksProcessed));
        }
        ...
        {
            return new ContextBuilder(task, AsCancellableActionTask(onAllTasksProcessedAsync));
        }
        ...
        {
            return new ContextBuilder(task, Taskify(onAllTasksProcessed));
        }
        ...
        {
            return new ContextBuilder<TResult>(task);
        }
        ...
        {
            return new ContextBuilder(task);
        }
        ...
        {
            return new ContextBuilder<TResult>(AsCancellableFuncTask(task), AsCancellableFuncTask(onAllTasksProcessedAsync));
        }
        ...
        {
            return new ContextBuilder<TResult>(AsCancellableFuncTask(task), Taskify(onAllTasksProcessed));
        }
        ...
        {
            return new ContextBuilder(AsCancellableActionTask(task), AsCancellableActionTask(onAllTasksProcessedAsync));
        }
        ...
        {
            return new ContextBuilder(AsCancellableActionTask(task), Taskify(onAllTasksProcessed));
        }
        ...
        {
            return new ContextBuilder<TResult>(AsCancellableFuncTask(task));
        }
        ...
        {
            return new ContextBuilder(AsCancellableActionTask(task));
        }
    }
}